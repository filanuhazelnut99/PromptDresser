...
def parse_args():
    ...
    parser.add_argument("--init_ip_adapter_path", type=str, default="./pretrained_models/IP-Adapter/sdxl_models/ip-adapter_sdxl.bin")
    parser.add_argument("--init_controlnet_path", type=str, default="./pretrained_models/controlnet-openpose-sdxl-1.0")
    parser.add_argument("--init_image_encoder_path", type=str, default="./pretrained_models/IP-Adapter/sdxl_models")
