...
#     import cv2
#     import numpy as np
#     img = cv2.imread("../inputs/model/00273_00.jpg").astype(np.float32)
#     tensor = torch.from_numpy(img)[None].permute(0,3,1,2)
#     freq_filter = get_freq_filter([1,3,1024,768], torch.device("cpu"), "gaussian", None, d_s=0.25, d_t=0.25)

#     noise = torch.randn_like(tensor)
#     output = freq_mix_2d(tensor, noise, LPF=freq_filter)